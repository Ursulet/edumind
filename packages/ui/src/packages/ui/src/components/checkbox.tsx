    ...
    return (
      <div className="flex items-start gap-3">
        <input
          ...
          id={inputId}
          type="checkbox"
          className={mt-0.5 h-4 w-4 rounded border-[#E2E8F0] text-[#0F766E] accent-[#0F766E] focus:ring-2 focus:ring-[#0F766E]/20 focus:ring-offset-1 disabled:opacity-50 cursor-pointer }
          {...props}
        />
        {(label || description) && (
          <div>
