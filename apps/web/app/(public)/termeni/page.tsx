        ...
        <Card className="bg-warm-surface border-border shadow-sm">
          <CardContent className="p-8 prose prose-slate max-w-none">
            ...
            <p className="text-primary-text mb-6 leading-relaxed">
              Acești Termeni și Condiții guvernează utilizarea platformei EduCariera de către părinți, elevi și specialiști în orientare vocațională. Prin accesarea platformei, sunteți de acord cu acești termeni.
            </p>

            <h2 className="text-2xl font-semibold text-primary-ink mb-4">2. Servicii Oferite</h2>
            <p className="text-primary-text mb-6 leading-relaxed">
              EduCariera oferă acces la instrumente de testare standardizată (ex. RIASEC) și sesiuni video de consiliere 1-la-1 cu specialiști acreditați. Toate rapoartele generate au un caracter consultativ.
            </p>
