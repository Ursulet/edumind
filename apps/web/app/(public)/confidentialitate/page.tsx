        ...
        <Card className="bg-warm-surface border-border shadow-sm">
          <CardContent className="p-8 prose prose-slate max-w-none">
            ...
            <p className="text-primary-text mb-6 leading-relaxed">
              EduCariera tratează cu maximă seriozitate confidențialitatea datelor dumneavoastră și ale copiilor. Colectăm doar informațiile strict necesare pentru furnizarea serviciului: nume, date de contact, și răspunsurile de la evaluările profesionale (RIASEC).
            </p>
