...
export default async function Page() {
  ...
  return (
    <div className="w-full py-6 md:py-8 px-4 md:px-8 max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[#1F2622]">Documente</h1>
      ...
      <div className="bg-white border border-[#E3DED3] rounded-2xl p-10 shadow-sm text-center">
        ...
        <p className="text-[14px] text-[#6B746F] mt-2">Detaliile pentru Documente vor fi disponibile într-o actualizare viitoare.</p>
      </div>
    </div>
  );
}